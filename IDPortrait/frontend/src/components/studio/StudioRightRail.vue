    ...
    >
      ...
      <n-collapse-item title="高级选项" name="adv">
        ...
        <div class="field">
          ...
          <n-slider v-model:value="params.faceRatio" :min="0.1" :max="0.5" :step="0.01" />
        </div>
        <div class="field">
          <div class="field-row">
            <label>头距顶距离</label>
          ...
          <n-slider v-model:value="params.headTopDistance" :min="0.02" :max="0.5" :step="0.01" />
        </div>
        <div class="field switch-row">
          <label>6 寸打印排版</label>
        ...
        <div v-if="params.genPrintLayout" class="field switch-row">
          <label>排版切割线</label>
          <n-switch v-model:value="params.layoutCropLine" size="small" />
        </div>
        <div class="field switch-row">
          <label>目标文件大小</label>
